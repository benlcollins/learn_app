...
UpLearn is a place to find and share the best digital learning resources. Each day new links are added and upvoted by the community. Join us so you can favorite resources for future reference. Or perhaps you'll find jobs that interest you, or bookmark them for later review. UpLearn is a community-driven site, so please join and contribute useful resources you've found.
...
* Error handling when missing "http://" from submitted link (see limitation section below)
